            ...
            <div>
                <div className="flex flex-col lg:flex-row justify-between lg:items-end gap-10">
                    <div className="text-sm space-y-1">
                        <p>2025 회장 이예나 010-4279-9940</p>
                        <p>2025 부회장 이제민 010-9676-1452</p>
                        <p>2025 총무 김예영 010-4390-9866</p>
                    </div>
                    ...
                    <div className="flex flex-col items-center text-center">
                        ...
                        <h2 className="font-medium">University of Seoul Computer Club QUIPU</h2>
                    </div>

                    <div className="text-sm space-y-1 text-end">
                        <p className="underline">
                            <a href="https://quipu-developers.github.io/24_2_main/" target="_blank">
                ...
                <div className="flex flex-col md:flex-row items-center justify-between space-y-4 md:space-y-0">
                    <div className="flex space-x-3">
                        ...
                        <a href="mailto:quipu0316@gmail.com" aria-label="Send email to QUIPU">
                            <AiFillMail size={24} />
                        </a>
                        <a
