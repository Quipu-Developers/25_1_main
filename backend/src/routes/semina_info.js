...
router.get('/', async (req, res) => {
    try {
        ...
        res
            .status(200)
            .json(
                {total_items: total_items, total_pages: total_pages, current_page: currentPage, items_per_page: itemsPerPage, items: finaldata}
            );
        /*
      {
    ...
    */
        ...
        res
            .status(500)
            .json({error: "서버 오류 발생", details: err.message});
    };
});
