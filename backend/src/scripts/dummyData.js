...
const insertDummyData = async () => {
  try {
    ...
    await File.bulkCreate([
      {
        file_url: "https://zippy.b-cdn.net/main24_img1.png",
        file_type: "image",
        semina_id: 1,
      },
      {
        file_url: "https://zippy.b-cdn.net/룰렛24_img5.jpeg",
        file_type: "image",
        semina_id: 1,
      },
      {
        file_url: "https://zippy.b-cdn.net/quipu_pdf_test_file.pdf",
        file_type: "pdf",
        semina_id: 1,
      },
      {
        file_url: "https://zippy.b-cdn.net/articket_img1.jpeg",
        file_type: "image",
        semina_id: 2,
      },
      {
      ...
      {
        file_url: "https://zippy.b-cdn.net/_배틀글라운드_img1.jpeg",
        file_type: "image",
        semina_id: 3,
      },
      {
      ...
      {
        file_url: "https://zippy.b-cdn.net/_배틀글라운드_img2.jpeg",
        file_type: "image",
        semina_id: 5,
      },
      {
      ...
      {
        file_url: "https://zippy.b-cdn.net/backoffice_img1.png",
        file_type: "image",
        semina_id: 7,
      },
      {
    ...
    await Feature.bulkCreate([{ feature_name: "recruit", is_enabled: true }]);
